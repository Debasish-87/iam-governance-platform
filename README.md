...
```markdown
![IAM Governance Dashboard](docs/IAM_Governance_Platform_Dashboard.png)
```

### CloudWatch Dashboard

```markdown
![CloudWatch Dashboard](docs/CloudWatchUse_Dashboard.png)
```

### Lambda Dashboard

```markdown
![Lambda Dashboard](docs/Lambda_Dashboard.png)
```

### DynamoDB Dashboard

```markdown
![DynamoDB Dashboard](docs/DynamoDB_Dashboard.png)
```

### EventBridge Dashboard

```markdown
![EventBridge Dashboard](docs/EventBridge_Dashboard.png)
```

### CloudWatch Logs Dashboard

```markdown
![CloudWatch Logs](docs/CloudWatchLogs_Dashboard.png)
```
